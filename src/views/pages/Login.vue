...
<template>
  <div class="h-screen flex w-full bg-img vx-row no-gutter items-center justify-center" id="page-login">
    <div class="vx-col sm:w-1/2 md:w-1/2 lg:w-1/4 xl:w-1/4 sm:m-0 m-4">
      <vx-card>
            ...
            <div class="vx-col sm:w-full md:w-full lg:w-full d-theme-dark-bg">
              <div class="p-8 login-tabs-container">
                ...
                <div>
                  ...
                  <vs-button @click.prevent="login()" class="float-right mb-base">Login</vs-button>
    ...
    login() {
      ...
      this.$store
        ...
        .then(() => {
          ...
          const payloadheader = HeaderAuth();

          this.$store
          .dispatch("INFOUSER", payloadheader)
          .then(() => {
