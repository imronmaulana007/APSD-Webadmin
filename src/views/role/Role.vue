                ...
                <!-- SLOT = ACTION -->
                 ...
                 <div class="export-table">
                    <vs-table :data="datas" search pagination max-items="5">
                        <template slot="thead">
                        <vs-th sort-key="id"> No     </vs-th>
                        <vs-th sort-key=""> #     </vs-th>
                        <vs-th sort-key="role_name"> Role Name   </vs-th>
...
export default {
  ...
  data() {
    return {
      ...
      cellAutoWidth: true,
      selectedFormat: "xlsx",
      headerTitle: ["Id", "Role Name","Status"],
      headerVal: ["id", "role_name","status"],
      datas: [],
      activePrompt: false,
    }
  },
  methods: {
    ...
    async DeleteData(id,notif) {
        this.$store.dispatch("DELETE_ROLE", id).then(data => {
            this.datas = data;
